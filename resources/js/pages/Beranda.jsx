                ...
                <div className="container-page relative py-20 md:py-28">
                    <div className="max-w-3xl text-primary-foreground">
                        ...
                        <p className="mt-5 max-w-2xl text-lg leading-relaxed">
                            ...
                            cerita warga, wisata, dan UMKM desa dalam satu portal
                            yang mudah.
                        </p>
                ...
                <div className="grid gap-5 md:grid-cols-3">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-muted-foreground">
                                Lihat berbagai hasil usaha dan produk buatan warga
                                Desa Sobokerto.
                            </p>
                        </div>
                    </Link>
            ...
            <section className="container-page mt-24">
                <div className="grid items-center gap-10 overflow-hidden rounded-3xl border border-border bg-primary-soft md:grid-cols-2">
                    <div className="p-8 md:p-12">
                        ...
                        <p className="mt-4">
                            Nikmati panorama alam Waduk Cengklik bersama
                            keluarga.
                        </p>
                    ...
                    <div className="h-64 md:h-full">
                        <img
                            src={wisataCengklik}
                            className="size-full object-cover"
                            alt="Pemandangan Waduk Cengklik"
                        />
                    </div>
                </div>
            </section>
